<template>
  <div class="content">
    ...
    <div class="buttons">
      ...
      <el-button class="bluecolor" @click="onclick('Save And New')">保存并新建</el-button>
      <el-button class="bluecolor" @click="onclick('Save And Back')">保存返回</el-button>
      <el-button class="greycolor" @click="onclick('Back To Dashboard')">返回在线报表</el-button>
    </div>
    <!-- options配置项 -->
    <div class="options">
      <el-row>
        ...
        <el-col :span="6">
          ...
          <el-form label-width="80px" label-position='left'>
            <el-form-item label="图表名称">
              <el-input size="mini" class="TiemTitle" v-model="options.TiemTitle"></el-input>
            </el-form-item>
            <el-form-item label="范围">
              <el-select size="mini" v-model="ScopeValue">
                <el-option
                ...
                <div class="color-options">
                  <el-form label-width="80px" label-position='left'>
                    <el-form-item label="Open">
                      <el-input class="color-input" v-model="colorOptions.Open" size="mini" placeholder="#000000"></el-input>
                    </el-form-item>
                    <el-form-item label="Fix">
                      <el-input class="color-input" v-model="colorOptions.Fix" size="mini" placeholder="#000001"></el-input>
                    </el-form-item>
                    <el-form-item label="Close">
                      <el-input class="color-input" v-model="colorOptions.Close" size="mini" placeholder="#002001"></el-input>
                    </el-form-item>
                    <el-form-item label="Assign">
                      <el-input class="color-input" v-model="colorOptions.Assign" size="mini" placeholder="#000101"></el-input>
                    </el-form-item>
                  </el-form>
                </div>
              </div>
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                type="text"
                style="color: #000000"
                @click="handleUp(scope.$index, scope.row)">Up</el-button>|<el-button
                size="mini"
                type="text"
                style="color: #000000"
                @click="handleDown(scope.$index, scope.row)">Down</el-button>
            </template>
          </el-table-column>
          <el-table-column
            width="200"
