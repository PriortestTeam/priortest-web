    ...
    <el-card>
      <el-tabs v-model="activeName" type="card" :before-leave="handBeforeLeave">
        <el-tab-pane label="新建" name="first">
          <el-form ref="testCaseForm" :model="testCaseForm" :rules="testCaseRules" label-width="120px"
            class="demo-ruleForm">
            <div>
              <el-button v-if="!testCaseForm.id && isEdit" type="primary" @click="submitForm('testCaseForm', false)">保存并新建
              </el-button>
              <el-button v-if="!testCaseForm.id && isEdit" type="primary" @click="submitForm('testCaseForm', true)">保存并返回
              </el-button>
              <el-button v-if="!testCaseForm.id && isEdit" type="primary" @click="submitForm('testCaseForm', false)">保存
              </el-button>
