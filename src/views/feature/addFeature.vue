     ...
     >
      <div>
             ...
             <el-button
               ...
               >确认修改</el-button
             >
             <el-button type="primary" @click="giveupBack('featureFrom')">放弃</el-button>
        ...
        <el-row>
          ...
          >
            ...
            <el-form-item
              ...
              label-width="140px"
            >
              <el-input v-model="featureFrom[field.fieldName]" type="text" />
            </el-form-item>
            <!-- textarea -->
            <el-form-item
            ...
            >
              <el-input
                v-model="featureFrom[field.fieldName]"
                type="textarea"
                :rows="2"
                placeholder="请输入内容"
              />
            ...
            <el-form-item
              ...
              label-width="140px"
            >
              <el-checkbox v-model="featureFrom[field.fieldName]" />
            </el-form-item>
            <!-- 日期 -->
            <el-form-item
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (this.featureFrom.id) {
            ...
            param.featureId = this.featureFromTemp.featureId
            editFeature(param)
              .then((res) => {
                if (res.code === '200') {
